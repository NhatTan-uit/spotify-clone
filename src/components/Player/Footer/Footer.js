  ...
  return (
    <div className='footer'>
        ...
        <div className='footer_middle'>
            ...
            {
              playing ? (
                <PauseCircleIcon onClick={handlePlayPause} fontSize='large' className='footer_icon' />
              ) : (
                <PlayCircleIcon onClick={handlePlayPause} fontSize='large' className='footer_icon' />
              )
            }
